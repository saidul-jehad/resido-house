            ...
            >
                <SwiperSlide>
                    <div className=" flex items-center justify-center flex-col gap-5 text-white bg-[url('https://cdna.artstation.com/p/assets/images/images/015/507/918/large/ahmed-mohamed-finish.jpg')] min-h-[700px] bg-no-repeat bg-cover">
                        ...
                        <p className='md:w-3/5 w-4/5 mx-auto animate__animated animate__lightSpeedInLeft'>Explore a curated collection of exquisite residences tailored to your lifestyle. Find the perfect blend of luxury, comfort, and sophistication in our premier residential estate listings. Start your journey now</p>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
